...
contract Pausable is Ownable {
    ...
    event Paused(address addressTrigger);
    event Unpaused(address addressTrigger);
}
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Alredy owner of the token");
        require(
            _isApprovedOrOwner(msg.sender, tokenId),
            "Sender has to be owner of the token or Approved for it."
        );
    ...
    function _transferFrom(
        ...
        require(ownerOf(tokenId) == from, "Not Owner of the token");
        require(to != address(0), "Invalid Address");
